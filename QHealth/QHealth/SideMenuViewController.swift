...
class SideMenuViewController: UIViewController, UIGestureRecognizerDelegate{
    ...
    let MENU_ARRAY:NSArray = ["My Health", "Ask a doctor", "My Diary", "Settings", "Support", "Contact Us"]
    let MENU_DIC:NSDictionary = ["My Health" : "dashBoard", "Ask a doctor" : "goal", "My Diary" : "diary", "Settings" : "settings_menu", "Support" : "settings_menu", "Contact Us" : "settings_menu"]
